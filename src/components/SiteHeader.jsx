...
// Full-width header. Title now uses a Times-like serif (defined in App.css).
// Byline (text + marty.webp) sits immediately to the right of the title.
  ...
  return (
    <header className="site-header noprint">
      <div className="site-header__inner">
        ...
        {/* Center: title + byline inline and centered as one block */}
        <div className="site-header__center">
          <div className="title-line">
            <h1 className="site-title">Kaspa Paper Wallet Generator</h1>

            {/* Byline directly to the right of the title */}
